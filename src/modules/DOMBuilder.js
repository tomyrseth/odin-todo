...
export class DOMBuilder {
  ...
  clearContentDiv() { this.contentDiv.replaceChildren(''); }
  ...
  buildProjectsPage() {
    ...
    this.contentDiv.appendChild(outerContainer);
    ...
    const projectForm = this.buildProjectForm();
    projectForm.id = 'projectForm';
    this.contentDiv.appendChild(projectDia);
  ...
  buildAllTodosInProject(proj) {
    ...
    todoDia.id = 'todoDia';
    const todoForm = this.buildTodoForm();
    todoForm.id = 'todoForm';
    todoForm.dataset.projectid = proj.id;
    this.contentDiv.appendChild(todoDia);
  ...
  buildSingleTodo(todo) {
    ...
    this.contentDiv.appendChild(backBtn2);

    //Todo Inner div
    const todoPropLength = todoProperties.length;
    const innerDiv = document.createElement('div');
    this.contentDiv.appendChild(innerDiv);
